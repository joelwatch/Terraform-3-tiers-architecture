...
# Use data source to get all availability zones in region to liste all availability zones
data "aws_availability_zone" "avalaibility_zones" {}

# Create public subnet az1
resource "aws_subnet" "public_subnet_az1" {
  vpc_id                    = aws_vpc.vpc.id
  cidr_block                = var.public_subnet_az1_cidr
  availability_zone         = data.aws_availability_zone.avalaibility_zones.names[0]
...
resource "aws_subnet" "public_subnet_az2" {
  ...
  availability_zone         = data.aws_availability_zone.avalaibility_zones.names[1]
  map_public_ip_on_launch   = true
