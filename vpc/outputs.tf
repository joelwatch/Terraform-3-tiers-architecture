...
# export the first availbility zone
output "availbility_zone_1" {
  value = data.aws_availability_zone.avalaibility_zones.names[0]
}

# export the second availbility zone
output "availbility_zone_2" {
  value = data.aws_availability_zone.avalaibility_zones.names[1]
}